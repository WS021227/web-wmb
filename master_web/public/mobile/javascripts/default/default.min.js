...
var share_lang = Object.assign({}, aswter1, {})
...
function get_lang(_lang, aswter, index_name) {
    try {
        return aswter[index_name][_lang]
    } catch (e) {
        return ''
    }
}
...
function unity_lang(key) {
    ...
    return (share_lang[key] || {})[lang] || ''
}

/**
 * 敏感地区过滤
 * @type {{macao: string, taiwan: string, "hong kong": string}}
 */
...
let sensitive_countries_iup = {
    'taiwan': 'China Taiwan',
    'hong kong': 'China Hong kong',
    'macao': 'China Macao'
}

function sensitive_country_iup(country) {
    country = country ? country.toString() : ''
    return sensitive_countries_iup[country.toLowerCase().toClear()] || country
}

function search_toast() {
    let img_src = $(".container").data("img")
    console.log(img_src, "img链接")
...
function text_toast(e) {
    let img_src = $(".container").data("img")
    let img_version = $(".container").data("version")
    var t = document.createElement("div");
    t.className = "text_toast", t.innerHTML = `\n     <div class="alert">\n          <span>${e.p1}</span>\n      <span>${e.p2}</span>\n      ${!e.p3?`<img src='${img_src}mobile/images/company/company_list/text_close.png?v=${img_version}' class="close"></img>`:""}\n      </div>\n      `;
    var n = document.querySelector("body");
    n.appendChild(t);
    // 有按钮
    if (!e.p3) {
...
//单按钮弹窗
function buy_vip_toast1(e, t, n1, i1,del_show) {
    let img_src = $(".container").data("img")
    console.log(e, t, n1, i1)
    var r = document.createElement("div");
    r.className = "buy_vip_toast1", r.innerHTML = `\n      <div class="alert">\n      <h3>${e}</h3>\n      <span>${t}</span>\n      <div>   <a id="buy_vip_toast1_l_btn" href="${i1}">${n1}</a>     </div>\n  ${!del_show?`<img src='${img_src}/mobile/images/company/company_list/text_close.png' class="close"></img>`:""}\n      </div>\n      `;
    var o = document.querySelector("body");
    o.appendChild(r),
...
//单按钮弹窗
function buy_vip_toast_jxzf(e, t, n1, i1) {
    let img_src = $(".container").data("img")
    console.log(e, t, n1, i1)
    var r = document.createElement("div");
    r.className = "buy_vip_toast1", r.innerHTML = `\n      <div class="alert">\n      <h3>${e}</h3>\n      <span>${t}</span>\n      <div>   <a id="buy_vip_toast1_l_btn" href="javascript:void(0)" onclick="${i1}">${n1}</a>     </div>\n  <img src="${img_src}mobile/images/company/company_list/text_close.png" class="close">\n      </div>\n      `;
    var o = document.querySelector("body");
    o.appendChild(r),
        $("#buy_vip_toast1_l_btn").click(function () {
            o.removeChild(r)
...
(function(){
    // let user=wg.user.id
    // if(!user)  return buy_vip_toast(`${get_lang(lang,aswter1,"a15")}`, `${get_lang(lang,aswter1,"a16")}`, `${get_lang(lang,aswter1,"a17")}`, `${get_lang(lang,aswter1,"a18")}`, `login`, `register`);
    let $box=$(`
    <a class="qywxkf" id="qywxkf" href="https://work.weixin.qq.com/kfid/kfc3dfafec65ecf8375">
    <svg t="1681203800947" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5710" width="30" height="30"><path d="M184.32 521.216V266.24c-3.584 0-7.168 0-10.752 0.512 57.856-125.44 186.88-212.992 336.896-212.992 150.016 0 279.04 87.552 336.896 212.992-3.584-0.512-7.168-0.512-10.752-0.512v255.488c72.192 0 130.56-57.344 130.56-127.488 0-47.616-27.136-89.6-66.56-111.616-56.32-158.208-209.408-271.36-389.632-271.36-180.736 0-333.824 113.664-389.632 271.36-39.936 22.016-66.56 63.488-66.56 111.616-1.024 70.144 57.344 126.976 129.536 126.976zM792.064 667.648c-73.728 67.584-173.056 108.544-281.6 108.544-108.544 0-207.872-40.96-281.6-108.544C96.768 734.72 10.24 852.992 10.24 1013.76h1003.52c0-161.28-88.064-279.552-221.696-346.112z" fill="#0D52AD" p-id="5711"></path><path d="M510.464 138.752c-156.16 0-282.624 123.904-282.624 276.48s126.464 276.48 282.624 276.48c156.16 0 282.624-123.904 282.624-276.48-0.512-152.576-126.976-276.48-282.624-276.48z m1.536 436.224c-47.104 0-85.504-28.16-85.504-62.976h171.008c0 34.816-38.4 62.976-85.504 62.976z" fill="#0D52AD" p-id="5712"></path></svg>    </a>`)
    $('body').append($box)
})()